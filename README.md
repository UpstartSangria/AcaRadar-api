...
```bash
curl "https://acaradar-api-10b2af109247.herokuapp.com/api/v1/papers?journals%5B%5D=MIS+Quarterly&journals%5B%5D=Management+Science&page=1"   --cookie /tmp/acaradar_cookie.jar -w "\nHTTP Status: %{http_code}\n"
