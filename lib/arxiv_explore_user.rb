...
def keyword_extraction(text)
    ...
    keywords = tgr.get_nouns(tagged).keys.join('+')
end
...
def run()
    puts "Hello! Please describe what kind of article you are looking for. We will pull two articles from ArXiV matching the keywords of your prompt."
